                            ...
                            <div class="col-md-4 col-md-offset-4">
                                <div class="login-panel panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <form role="form" action="php/update-details.php" method="post">
                                            <fieldset>
                                                <label style="color: red;">
                                                    <?php
                                                        if(isset($_SESSION['err_msg'])){
                                                            echo $_SESSION['err_msg']; // display the message
                                                            unset($_SESSION['err_msg']); // clear the value so that it doesn't display again
                                                        }  
                                                    ?>            
                                                </label>
                                                ...
                                                <div class="form-group">
                                                    <input class="form-control" placeholder="mobile" name="mobile" type="text" pattern="^[6789]\d{9}$" title="10 Digit mobile number starting with digit 6,7,8 or 9 only." required value="">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <input type="submit" class="btn btn-lg btn-success btn-block" value="Save & Continue">
                                            </fieldset>
                                        </form>
                                    </div>
                                </div>
