    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-right" >
                ...
                <li class="dropdown" style="margin-right: 30px">
                    <a href="dashboard.php"> <button style="background-color:cornflowerblue; color: white" class="btn">
        ...
        <div id="page-wrapper" style="margin: 0 0 0 0">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="page-header">Test Finished</h2>
                                ...
                                <div class="fh5co-intro no-js-fullheight">
                                    <div class="fh5co-intro-text">
                                        ...
                                        <div class="fh5co-center-position">
                                            <div id="main-content" >
                                                <div>
                                                    <p>Your exam has been been finished. Now you can check your result on result page on dashboard. <a href="dashboard.php">click here</a> to go to Dashboard and check your result.</p>
                                                </div>
